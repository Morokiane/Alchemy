...
function Title()
	...
	elseif timer>=100 then
		...
		if not menu then
			print("Press X to Start",75,h/2+52,1,true)
		end
	end
	--tri(x1 y1 x2 y2 x3 y3 color)
	if btnp(c.x) and not menu then
		menu=true
	end
	...
	if menu then
		...
		if btnp(c.z) and pt==0 then
			loadGame=true
			TIC=Update
		elseif btnp(c.z) and pt==6 then
			if pmem(0)==0 then
				return
			else
				Load()
		...
		elseif btnp(c.z) and pt==12 then
			TIC=Options
		end
	end
end
...
function Shop()	
	if p.inShop then
		...
		elseif selX==75 and selY==70 then
			...
			if btnp(c.s) and p.coins>=40 and stabplus==0 then
				stabplus=1
				p.coins=p.coins-40
			end
		elseif selX==123 and selY==70 then
			...
			if btnp(c.s) and p.coins>=99 and backpack==0 then
				p.stabPotMax=6
				backpack=1
				p.coins=p.coins-1
			end
...
-- <MAP>
-- 000:
-- 001:
-- 002:
-- 003:
...
-- 009:
-- 010:
-- 011:
-- 012:
-- 013:
-- 014:
...
-- 016:
...
-- <FLAGS>
-- 000:
