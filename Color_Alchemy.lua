...
function Options()
	...
	if btnp(c.r) and pto==0 and ctrlPrompt.keyb==1 then
		ctrlPrompt.keyb=0
	elseif btnp(c.l) and pto==0 and ctrlPrompt.keyb==0 then
		ctrlPrompt.keyb=1
	end
